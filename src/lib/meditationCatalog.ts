...
export const MEDITATION_CATALOG: MeditationCatalogEntry[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { atSec: 38, type: 'voice', text: '鼻からゆっくり息を吸います。そして、ゆっくり吐きます。もう一度。吸って。吐いて。呼吸のたびに、体の力を少しずつ緩めていきます。', audioText: '鼻からゆっくり息を吸います。そして、ゆっくり吐きます。もう一度。吸って。はいて。呼吸のたびに、からだの力を少しずつ緩めていきます。', audioKey: 'voice-nidra350-breath' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { atSec: 95, type: 'voice', text: '次に、自分の呼吸へ意識を向けます。息を吸うと、お腹がやさしく膨らみます。息を吐くと、お腹が自然に戻ります。呼吸を変えようとせず、その動きをただ観察していきます。', audioText: '次に、自分の呼吸へ意識を向けます。息を吸うと、おなかがやさしく膨らみます。息を吐くと、おなかが自然に戻ります。呼吸を変えようとせず、その動きをただ観察していきます。', audioKey: 'voice-nidra10-observe-breath' },
