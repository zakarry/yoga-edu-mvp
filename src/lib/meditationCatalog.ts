...
export const MEDITATION_CATALOG: MeditationCatalogEntry[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { atSec: 70, type: 'voice', text: '体のそれぞれの場所へ、順番に意識を移していきます。右手の親指。人差し指。中指。薬指。小指。右の手のひら。手首。前腕。肘。上腕。肩。右の腰。太もも。膝。ふくらはぎ。足首。かかと。足の裏。足の指。', audioText: 'からだのそれぞれの場所へ、順番に意識を移していきます。右手の親指。人差し指。なかゆび。薬指。こゆび。右の手のひら。手首。ぜんわん。肘。上腕。肩。右の腰。太もも。膝。ふくらはぎ。足首。かかと。足の裏。足の指。', audioKey: 'voice-nidra350-body-right' },
      ...
      { atSec: 130, type: 'voice', text: '意識を背面へ移します。肩甲骨。背骨。腰。お尻。続いて前面へ。お腹。胸。鎖骨。喉。顔。目。頭頂部。', audioText: '意識を背面へ移します。けんこうこつ。せぼね。腰。お尻。続いて前面へ。おなか。胸。さこつ。喉。顔。目。頭頂部。', audioKey: 'voice-nidra350-body-back-front' },
  ...
  },
  {
    ...
    timeline: [
      { atSec: 0, type: 'voice', text: 'ヨガニードラとは、サンスクリット語で「ヨガの眠り」を意味する言葉です。心と体を深いリラクゼーションと瞑想へと導いていくプラクティスです。意識を保ちながら、覚醒と睡眠の間にある、静かで心地よい状態へと入っていきます。', audioText: 'ヨガニードラとは、サンスクリット語で「ヨガの眠り」を意味する言葉です。心とからだを深いリラクゼーションと瞑想へと導いていくプラクティスです。いしきをたもちながら、覚醒と睡眠の間にある、静かで心地よい状態へと入っていきます。', audioKey: 'voice-nidra10-intro' },
      ...
      { atSec: 155, type: 'voice', text: '右手の親指。人差し指。中指。薬指。小指。右の手のひら。手の甲。手首。前腕。肘。上腕。肩。脇の下。右の腰。股関節。太もも。膝。ふくらはぎ。足首。かかと。足の裏。右足の親指。人差し指。中指。薬指。小指。', audioText: '右手の親指。人差し指。なかゆび。薬指。こゆび。右の手のひら。手の甲。手首。ぜんわん。肘。上腕。肩。脇の下。右の腰。股関節。太もも。膝。ふくらはぎ。足首。かかと。足の裏。右足の親指。人差し指。なかゆび。薬指。こゆび。', audioKey: 'voice-nidra10-body-right' },
      { atSec: 190, type: 'voice', text: '続いて左側です。左手の親指。人差し指。中指。薬指。小指。左の手のひら。手の甲。手首。前腕。肘。上腕。肩。脇の下。左の腰。股関節。太もも。膝。ふくらはぎ。足首。かかと。足の裏。左足の親指。人差し指。中指。薬指。小指。', audioText: '続いて左側です。左手の親指。人差し指。なかゆび。薬指。こゆび。左の手のひら。手の甲。手首。ぜんわん。肘。上腕。肩。脇の下。左の腰。股関節。太もも。膝。ふくらはぎ。足首。かかと。足の裏。左足の親指。人差し指。なかゆび。薬指。こゆび。', audioKey: 'voice-nidra10-body-left' },
      { atSec: 225, type: 'voice', text: '意識を体の背面へ移します。右のお尻。左のお尻。腰の低い部分。背中の高い部分。背骨全体。頭の後ろ。続いて前面へ。おでこ。右の眉。左の眉。眉間。右目。左目。右耳。左耳。右の頬。左の頬。鼻。唇。あご。喉。右の胸。左の胸。みぞおち。お腹。下腹部。', audioText: '意識をからだの背面へ移します。右のお尻。左のお尻。腰の低い部分。背中の高い部分。せぼね全体。頭の後ろ。続いて前面へ。おでこ。右の眉。左の眉。みけん。右目。左目。右耳。左耳。右の頬。左の頬。鼻。唇。あご。喉。右の胸。左の胸。みぞおち。おなか。下腹部。', audioKey: 'voice-nidra10-body-back-front' },
      { atSec: 265, type: 'voice', text: '体全体を感じていきます。右脚全体。左脚全体。両脚全体。右腕全体。左腕全体。両腕全体。頭部。胴体。そして、体全体をひとつのものとして感じます。体の重さを床に委ねて、深くリラックスしていきます。', audioText: 'からだ全体を感じていきます。みぎあし全体。ひだりあし全体。りょうあし全体。右腕全体。左腕全体。両腕全体。頭部。どうたい。そして、からだ全体をひとつのものとして感じます。からだの重さを床に委ねて、深くリラックスしていきます。', audioKey: 'voice-nidra10-whole-body' },
