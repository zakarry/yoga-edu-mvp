...
export const MEDITATION_CATALOG: MeditationCatalogEntry[] = [
  ...
  },
  {
    ...
    timeline: [
      { atSec: 0, type: 'voice', text: 'ヨガニードラとは、サンスクリット語で「ヨガの眠り」を意味する言葉です。体を深く休ませながら、意識を静かに保っていくリラクゼーションと瞑想の実践です。', audioKey: 'voice-nidra350-intro' },
      { atSec: 18, type: 'voice', text: 'シャヴァーサナで、仰向けに楽に横になりましょう。脚を少し開き、腕は体から離して、手のひらを上に向けます。そっと目を閉じます。', audioKey: 'voice-nidra350-posture' },
      { atSec: 38, type: 'voice', text: '鼻からゆっくり息を吸います。そして、ゆっくり吐きます。もう一度。吸って。吐いて。呼吸のたびに、体の力を少しずつ緩めていきます。', audioKey: 'voice-nidra350-breath' },
      { atSec: 60, type: 'voice', text: '眠ろうとせず、声を聞きながら、静かに意識を保っていきましょう。', audioKey: 'voice-nidra350-stay-awake' },
      { atSec: 70, type: 'voice', text: '体のそれぞれの場所へ、順番に意識を移していきます。右手の親指。人差し指。中指。薬指。小指。右の手のひら。手首。前腕。肘。上腕。肩。右の腰。太もも。膝。ふくらはぎ。足首。かかと。足の裏。足の指。', audioKey: 'voice-nidra350-body-right' },
      { atSec: 105, type: 'voice', text: '次に左側。左手。手首。前腕。肘。上腕。肩。左の腰。太もも。膝。ふくらはぎ。足首。かかと。足の裏。足の指。', audioKey: 'voice-nidra350-body-left' },
      { atSec: 130, type: 'voice', text: '意識を背面へ移します。肩甲骨。背骨。腰。お尻。続いて前面へ。お腹。胸。鎖骨。喉。顔。目。頭頂部。', audioKey: 'voice-nidra350-body-back-front' },
      { atSec: 155, type: 'voice', text: '今、床に横たわっている体全体を感じます。体の重さを、そのまま床に委ねてください。何かをしようとせず、静けさを感じていきます。', audioKey: 'voice-nidra350-whole-body' },
      { atSec: 172, type: 'voice', text: '自然な呼吸を、変えようとせずにただ観察します。吸う息。吐く息。一つひとつの呼吸を感じていきます。', audioKey: 'voice-nidra350-observe-breath' },
      { atSec: 188, type: 'voice', text: '心と体を、もう少しだけ深いリラクゼーションへと委ねます。静かに休みましょう。', audioKey: 'voice-nidra350-deep-relax' },
      { atSec: 188, type: 'silence', durationSec: 12 },
      { atSec: 200, type: 'voice', text: 'ゆっくりと意識を体へ戻します。手の指先、足の指先を少しずつ動かします。深くひと呼吸。準備ができたら、ゆっくりと目を開けてください。', audioKey: 'voice-nidra350-return' },
  ...
  },
  {
    ...
    timeline: [
      { atSec: 0, type: 'voice', text: 'ヨガニードラとは、サンスクリット語で「ヨガの眠り」を意味する言葉です。心と体を深いリラクゼーションと瞑想へと導いていくプラクティスです。意識を保ちながら、覚醒と睡眠の間にある、静かで心地よい状態へと入っていきます。', audioKey: 'voice-nidra10-intro' },
      { atSec: 25, type: 'voice', text: 'それでは、シャヴァーサナ、仰向けの姿勢で楽に横になりましょう。足は肩幅より少し広めに開き、つま先は自然に外側へ。腕は体から少し離し、手のひらを上に向けて、そっと置きます。静かに目を閉じます。ここからは、できるだけ体を動かさず、目も閉じたまま、声を聞いていきましょう。', audioKey: 'voice-nidra10-posture' },
      { atSec: 60, type: 'voice', text: '心の中で、自分自身にこう伝えます。「私は今からヨガニードラを行います。眠ってしまわず、意識を保ち続けます。」', audioKey: 'voice-nidra10-intention' },
      { atSec: 75, type: 'voice', text: '今、自分の周りから聞こえてくる、一番遠くの音に耳を澄ませます。音の正体を探る必要はありません。ただレーダーのように、音から音へと意識を移していきます。', audioKey: 'voice-nidra10-distant-sounds' },
      { atSec: 95, type: 'voice', text: '次に、自分の呼吸へ意識を向けます。息を吸うと、お腹がやさしく膨らみます。息を吐くと、お腹が自然に戻ります。呼吸を変えようとせず、その動きをただ観察していきます。', audioKey: 'voice-nidra10-observe-breath' },
      ...
      { atSec: 140, type: 'voice', text: 'ここから、体のそれぞれの部位へ、順番に意識を移していきます。名前を呼ばれた場所を動かす必要はありません。ただ、その場所へ意識を移し、力を緩めていきます。まずは右側から。', audioKey: 'voice-nidra10-body-scan-intro' },
      { atSec: 155, type: 'voice', text: '右手の親指。人差し指。中指。薬指。小指。右の手のひら。手の甲。手首。前腕。肘。上腕。肩。脇の下。右の腰。股関節。太もも。膝。ふくらはぎ。足首。かかと。足の裏。右足の親指。人差し指。中指。薬指。小指。', audioKey: 'voice-nidra10-body-right' },
      { atSec: 190, type: 'voice', text: '続いて左側です。左手の親指。人差し指。中指。薬指。小指。左の手のひら。手の甲。手首。前腕。肘。上腕。肩。脇の下。左の腰。股関節。太もも。膝。ふくらはぎ。足首。かかと。足の裏。左足の親指。人差し指。中指。薬指。小指。', audioKey: 'voice-nidra10-body-left' },
      { atSec: 225, type: 'voice', text: '意識を体の背面へ移します。右のお尻。左のお尻。腰の低い部分。背中の高い部分。背骨全体。頭の後ろ。続いて前面へ。おでこ。右の眉。左の眉。眉間。右目。左目。右耳。左耳。右の頬。左の頬。鼻。唇。あご。喉。右の胸。左の胸。みぞおち。お腹。下腹部。', audioKey: 'voice-nidra10-body-back-front' },
      { atSec: 265, type: 'voice', text: '体全体を感じていきます。右脚全体。左脚全体。両脚全体。右腕全体。左腕全体。両腕全体。頭部。胴体。そして、体全体をひとつのものとして感じます。体の重さを床に委ねて、深くリラックスしていきます。', audioKey: 'voice-nidra10-whole-body' },
      { atSec: 295, type: 'voice', text: '再び、お腹の呼吸へ意識を戻します。ここから呼吸を、27から1まで、心の中で逆方向に数えていきます。「息を吸って、お腹が膨らむ。27。」「息を吐いて、お腹が戻る。27。」次は26。途中で数が分からなくなったら、また27から始めます。眠ってしまわないように、ただ淡々と数えていきましょう。', audioKey: 'voice-nidra10-breath-count' },
      { atSec: 295, type: 'silence', durationSec: 120 },
      { atSec: 415, type: 'voice', text: '数を数えるのをやめます。心の中のスクリーンに、これから伝える風景を、ひとつずつ思い浮かべてみてください。静かな夜明けの海。激しく降る雨。暗闇に灯る、一本のろうそくの炎。', audioKey: 'voice-nidra10-imagery-1' },
      { atSec: 445, type: 'voice', text: '深く澄んだ湖。静かに流れていく、白い雲。そして、美しい富士山。', audioKey: 'voice-nidra10-imagery-2' },
      { atSec: 470, type: 'voice', text: 'それでは、最初に思い浮かべたあなたのサンカルパを、もう一度、心の中で3回繰り返します。', audioKey: 'voice-nidra10-sankalpa-repeat' },
      { atSec: 490, type: 'voice', text: '今、あなたの体が床やマットの上に横たわっている感覚を感じます。衣服が肌に触れている感覚。部屋の空気。周囲の気配。少しずつ、今いる場所へ意識を戻していきます。', audioKey: 'voice-nidra10-return-awareness' },
      { atSec: 510, type: 'voice', text: 'ここからは、心と体をさらに深いリラクゼーションの中へと委ねます。何かをしようとせず、ただ静けさの中で休んでいきます。', audioKey: 'voice-nidra10-deep-rest' },
      { atSec: 510, type: 'silence', durationSec: 60 },
      { atSec: 570, type: 'voice', text: '準備ができたら、ゆっくりと意識を体へ戻していきましょう。手の指先。足の指先。少しずつ、やさしく動かしていきます。', audioKey: 'voice-nidra10-return' },
      { atSec: 585, type: 'voice', text: '両足を中央へそろえます。両腕を伸ばし、体をゆっくり大きく伸ばします。深くひと呼吸。準備ができたら、ゆっくりと目を開けてください。ヨガニードラを終了します。', audioKey: 'voice-nidra10-ending' },
