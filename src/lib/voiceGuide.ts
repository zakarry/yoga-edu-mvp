...
const PHRASE_MAP: Record<string, string> = {
  ...
  '鼻からゆっくり吸って、お腹がふくらむのを感じます。': 'voice-abdominal-r1',
  '鼻からゆっくり吐いて、お腹がやさしく戻ります。': 'voice-abdominal-r2',
  '呼吸は無理のない範囲で続けましょう。': 'voice-abdominal-r3',
  '胸式呼吸を始めます。肩の力を抜いて、楽な姿勢をとりましょう。': 'voice-thoracic-intro-1',
  '鼻から吸って、胸の広がりを感じます。': 'voice-thoracic-r1',
  '鼻から吐いて、胸がやさしく戻るのを感じます。': 'voice-thoracic-r2',
  '肩を上げすぎず、無理のない呼吸で続けましょう。': 'voice-thoracic-r3',
  'お腹から胸、鎖骨の順に吸います。': 'voice-complete-r1',
  'ゆっくり吐いて、上から順に戻します。': 'voice-complete-r2',
  'お疲れさまでした。自然な呼吸に戻しましょう。': 'voice-abdominal-end',
  '吐きます。': 'voice-exhale',
  ...
  '鼻からゆっくり吸って。': 'voice-box-inhale',
  '鼻からゆっくり吐いて。': 'voice-box-exhale',
  'そのまま止めます。': 'voice-box-hold',
