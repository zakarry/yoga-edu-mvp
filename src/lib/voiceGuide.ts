...
const PHRASE_MAP: Record<string, string> = {
  ...
  '吸います。お腹、胸、鎖骨周辺へ。': 'voice-complete-inhale-r0',
  '吐きます。鎖骨、胸、お腹の順に戻します。': 'voice-complete-exhale-r0',
  'もう一度、お腹、胸、鎖骨へ。': 'voice-complete-inhale-r1',
  '鎖骨、胸、お腹へ戻します。': 'voice-complete-exhale-r1',
  'お腹、胸、鎖骨。': 'voice-complete-inhale-r2',
  '鎖骨、胸、お腹。': 'voice-complete-exhale-r2',
  'お疲れさまでした。自然な呼吸に戻りましょう。': 'voice-complete-outro',
...
export const ALL_VOICE_KEYS: string[] = [
  ...
  'voice-complete-inhale-r0', 'voice-complete-exhale-r0',
  'voice-complete-inhale-r1', 'voice-complete-exhale-r1',
  'voice-complete-inhale-r2', 'voice-complete-exhale-r2',
  'voice-complete-inhale-r3', 'voice-complete-exhale-r3',
  'voice-complete-final', 'voice-complete-outro',
