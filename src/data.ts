...
export interface Teacher {
  /** true: sample; false: formally classified; absent: not yet classified. */
  isDemo?: boolean;
  id: string;
  name: string;
  type: 'teacher';
...
export const schools: School[] = [
  ...
  { isDemo: true, id: 's10', name: '浅草ハーモニーヨガスクール', type: 'school', area: '浅草', lat: 35.711, lng: 139.7965, description: '浅草らしい開かれた雰囲気の中で、外国人対応と国際交流を自然に取り入れたスクールです。体験から継続受講までつながる導線があり、リラックス重視で安心して通えます。', schoolTypes: ['地域コミュニティ型', 'ヨガスタジオ'], programs: ['体験レッスン', '通常レッスン', 'イベント開催'], strengths: ['リラックス重視', '国際連携あり', '地域密着'], foreignSupportStatus: '積極的に受け入れ', languages: ['日本語', '英語', 'イタリア語'], internationalSupportLevel: '観光客対応', proYogaSupported: false, featured: false, priorityRank: 0, adminRecommended: false }
];

export const events: EventItem[] = [
  { isDemo: true, id: 'e1', name: '初心者のための朝ヨガ体験会', type: 'event', area: '渋谷', lat: 35.6612, lng: 139.6993, date: '2026-06-12', description: '週末の朝に気軽に参加しやすい、初心者歓迎の1DAY体験会です。初めてでも安心のやさしい流れで、呼吸を整えながら気持ちよく一日をスタートできます。', organizerType: 'スクール', eventTypes: ['体験会', '通常レッスン'], contentTags: ['リラックス', '睡眠', '呼吸法'], foreignParticipantStatus: '可能', languages: ['日本語', '英語'], hasInterpreter: false, isInternationalEvent: false },
  { isDemo: true, id: 'e2', name: 'プロYoga検定説明会', type: 'event', area: '銀座', lat: 35.672, lng: 139.7648, date: '2026-06-18', description: 'これから資格取得やプロYoga対応に興味がある方にぴったりの説明イベントです。初めてでも安心して参加でき、学びの流れをその場でイメージしやすい内容です。', organizerType: '連盟', eventTypes: ['講座', 'プロYoga説明会'], contentTags: ['資格対策', 'プロYoga', 'ヨガ哲学'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], hasInterpreter: true, isInternationalEvent: true },
  { isDemo: true, id: 'e3', name: '英語対応リラックスヨガワークショップ', type: 'event', area: '表参道', lat: 35.6658, lng: 139.7107, date: '2026-06-20', description: '英語対応・外国人対応ありで、国際交流も楽しめる明るいワークショップです。1DAY参加で気軽に体験でき、初めてでも安心してリラックスヨガに触れられます。', organizerType: '国際連携団体', eventTypes: ['ワークショップ', '国際イベント'], contentTags: ['呼吸法', '瞑想', '国際交流'], foreignParticipantStatus: '可能', languages: ['日本語', '英語', 'イタリア語'], hasInterpreter: true, isInternationalEvent: true },
  { isDemo: true, id: 'e4', name: '姿勢改善フローヨガ1DAY体験', type: 'event', area: '新宿', lat: 35.6892, lng: 139.6997, date: '2026-06-22', description: '体をしっかり動かしたい方におすすめの1DAY体験イベントです。初心者歓迎で、姿勢改善をテーマにしながらも楽しく参加しやすい空気感を大切にしています。', organizerType: '先生', eventTypes: ['体験会', '通常レッスン'], contentTags: ['運動系', 'ダイエット', '姿勢改善'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], hasInterpreter: false, isInternationalEvent: false },
  { isDemo: true, id: 'e5', name: 'やさしい産後ケアヨガ体験会', type: 'event', area: '世田谷', lat: 35.6458, lng: 139.6567, date: '2026-06-24', description: 'やさしい雰囲気で参加できる、地域密着の少人数体験会です。初めてでも安心の進行で、リラックスしながら無理なく体をほぐしたい方に向いています。', organizerType: 'ヨガクラブ', eventTypes: ['体験会', 'ワークショップ'], contentTags: ['リラックス', '睡眠', 'メンタルケア'], foreignParticipantStatus: '不可', languages: ['日本語'], hasInterpreter: false, isInternationalEvent: false },
  { isDemo: true, id: 'e6', name: '睡眠と呼吸を整えるヨガナイト', type: 'event', area: '吉祥寺', lat: 35.7037, lng: 139.5811, date: '2026-06-26', description: '仕事帰りや週末前にも参加しやすい、夜のリラックスイベントです。呼吸法を中心に、初めてでも安心して心身をゆるめられる1DAYプログラムになっています。', organizerType: 'スクール', eventTypes: ['ワークショップ'], contentTags: ['睡眠', '瞑想', '呼吸法'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], hasInterpreter: false, isInternationalEvent: false },
  { isDemo: true, id: 'e7', name: 'ヨガ哲学とつながる交流サロン', type: 'event', area: '上野', lat: 35.7126, lng: 139.7785, date: '2026-07-01', description: '学びと国際交流をいっしょに楽しめる、少人数の交流イベントです。初めてでも安心して会話に入れる雰囲気で、週末にゆったり参加したくなる内容です。', organizerType: '連盟', eventTypes: ['講座', 'チャリティイベント'], contentTags: ['ヨガ哲学', 'メンタルケア'], foreignParticipantStatus: '可能', languages: ['日本語', '英語', '中国語'], hasInterpreter: true, isInternationalEvent: true },
  { isDemo: true, id: 'e8', name: '肩こり改善ヨガ1DAY講座', type: 'event', area: '品川', lat: 35.6289, lng: 139.7392, date: '2026-07-03', description: '肩こり改善をテーマに、気軽に参加できる実践型1DAY講座です。働く方にも参加しやすく、初めてでも安心して姿勢改善のヒントを持ち帰れます。', organizerType: '企業', eventTypes: ['企業向けイベント', '講座'], contentTags: ['肩こり', '睡眠', 'メンタルケア'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], hasInterpreter: false, isInternationalEvent: false },
  { isDemo: true, id: 'e9', name: '浅草サンセット国際ヨガ体験', type: 'event', area: '浅草', lat: 35.7118, lng: 139.7989, date: '2026-07-05', description: '夕景の浅草で楽しむ、英語対応・外国人対応ありの国際交流イベントです。旅行中の方も地元の方も一緒に参加しやすく、初めてでも安心して楽しめます。', organizerType: '自治体', eventTypes: ['体験会', '国際イベント'], contentTags: ['リラックス', '国際交流', '呼吸法'], foreignParticipantStatus: '可能', languages: ['日本語', '英語', 'イタリア語'], hasInterpreter: true, isInternationalEvent: true },
  { isDemo: true, id: 'e10', name: '青山アライメント集中ワークショップ', type: 'event', area: '青山', lat: 35.6671, lng: 139.7144, date: '2026-07-09', description: '姿勢改善をじっくり深めたい方に向けた、少人数の集中ワークショップです。1DAYでも学びの満足感があり、基礎を見直したい方にも参加しやすい内容です。', organizerType: 'スクール', eventTypes: ['ワークショップ', '講座'], contentTags: ['肩こり', '腰痛', '姿勢改善'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], hasInterpreter: false, isInternationalEvent: false }
];

export const clubs: Club[] = [
  { isDemo: true, id: 'c1', name: '渋谷ウェルネスヨガ会', type: 'club', area: '渋谷', lat: 35.6605, lng: 139.703, description: '有志の集まりとして、地域で続けるヨガ習慣をゆるやかに楽しんでいるクラブです。初心者歓迎で、仲間と続ける心地よさを大切にしながら無理なく参加できます。', clubTypes: ['地域ヨガクラブ', '有志団体'], activities: ['定期レッスン', '勉強会', 'イベント参加'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], internationalExchangeAvailable: false },
  { isDemo: true, id: 'c2', name: '銀座プロYoga学習クラブ', type: 'club', area: '銀座', lat: 35.6705, lng: 139.762, description: '資格やプロYogaに関心のある人が自然に集まる、落ち着いた有志コミュニティです。学びも交流もほどよくあり、仲間と続ける感覚を大切にしています。', clubTypes: ['有志団体'], activities: ['検定学習会', 'プロYoga学習会', '勉強会'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], internationalExchangeAvailable: true },
  { isDemo: true, id: 'c3', name: '新宿オンラインヨガサークル', type: 'club', area: '新宿', lat: 35.6888, lng: 139.6958, description: 'オンライン中心で、ゆるく参加しやすい有志サークルです。初心者歓迎で、英語対応や外国人対応もあり、生活リズムに合わせて仲間と続けやすい雰囲気です。', clubTypes: ['有志団体', '職場ヨガクラブ'], activities: ['定期レッスン', 'イベント参加'], foreignParticipantStatus: '可能', languages: ['日本語', '英語', '中国語'], internationalExchangeAvailable: true },
  { isDemo: true, id: 'c4', name: '表参道グローバルヨガサークル', type: 'club', area: '表参道', lat: 35.6652, lng: 139.7098, description: '地域にいながら国際交流も楽しめる、親しみやすいヨガサークルです。少人数で声をかけ合いやすく、仲間と続ける楽しさを自然に感じられます。', clubTypes: ['国際交流型'], activities: ['定期レッスン', 'イベント参加', 'ボランティア'], foreignParticipantStatus: '可能', languages: ['日本語', '英語', 'イタリア語'], internationalExchangeAvailable: true },
  { isDemo: true, id: 'c5', name: '世田谷ゆるヨガクラブ', type: 'club', area: '世田谷', lat: 35.6447, lng: 139.6619, description: '地域で続けることを大切にした、やわらかな雰囲気のヨガクラブです。ゆるく参加しやすく、初心者やシニアの方も無理なく仲間に入りやすい空気があります。', clubTypes: ['地域ヨガクラブ', 'シニア向け', '親子向け'], activities: ['定期レッスン', 'ボランティア'], foreignParticipantStatus: '不可', languages: ['日本語'], internationalExchangeAvailable: false },
  { isDemo: true, id: 'c6', name: '吉祥寺コミュニティヨガ会', type: 'club', area: '吉祥寺', lat: 35.7019, lng: 139.5805, description: '仲間と続けることを楽しみたい方に向いた、地域密着のコミュニティです。イベントにもゆるく参加でき、日常の中でリラックスを続けやすい雰囲気があります。', clubTypes: ['地域ヨガクラブ', '有志団体'], activities: ['定期レッスン', 'イベント参加', '勉強会'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], internationalExchangeAvailable: false },
  { isDemo: true, id: 'c7', name: '品川アフター5ヨガクラブ', type: 'club', area: '品川', lat: 35.6297, lng: 139.7378, description: '仕事帰りにふらっと集まりやすい、親しみやすいヨガクラブです。肩こり改善や気分転換をテーマに、地域で無理なく続ける活動を行っています。', clubTypes: ['職場ヨガクラブ'], activities: ['定期レッスン', '勉強会'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], internationalExchangeAvailable: false },
  { isDemo: true, id: 'c8', name: '上野インターナショナルヨガ会', type: 'club', area: '上野', lat: 35.7135, lng: 139.7765, description: '英語対応・外国人対応があり、国際交流を楽しみながらゆるく参加できるコミュニティです。少人数で話しやすく、初心者でも仲間と続けやすい空気があります。', clubTypes: ['国際交流型', '有志団体'], activities: ['定期レッスン', 'イベント参加'], foreignParticipantStatus: '可能', languages: ['日本語', '中国語', '英語'], internationalExchangeAvailable: true },
  { isDemo: true, id: 'c9', name: '浅草つながるヨガサークル', type: 'club', area: '浅草', lat: 35.7122, lng: 139.7977, description: '地域の方も来訪者も自然につながれる、あたたかなヨガサークルです。ゆるく参加しやすく、リラックスしながら仲間と続ける時間を楽しめます。', clubTypes: ['国際交流型', '地域ヨガクラブ'], activities: ['イベント参加', 'ボランティア'], foreignParticipantStatus: '可能', languages: ['日本語', '英語', 'イタリア語'], internationalExchangeAvailable: true },
  { isDemo: true, id: 'c10', name: '青山姿勢改善ヨガ研究会', type: 'club', area: '青山', lat: 35.6662, lng: 139.714, description: '姿勢改善をテーマにしつつも、堅すぎず仲間と学び続けられる有志の集まりです。少人数で顔なじみになりやすく、地域で続ける安心感があります。', clubTypes: ['有志団体'], activities: ['勉強会', '検定学習会', '定期レッスン'], foreignParticipantStatus: '一部可能', languages: ['日本語', '英語'], internationalExchangeAvailable: false }
];
