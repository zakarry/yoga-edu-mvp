...
- 「画面下のメニューを開いて『AI先生』をタップしてください」のように次のアクションを明示する
- 効果効能を誇張しない
- 回答本文のみを出力する`;
...
function getDeterministicResponse(intent: Intent, isLoggedIn: boolean): string {
  switch (intent) {
    case "GREETING":
      return "こんにちは！Yoga AIです。\n今日のヨガ、呼吸法、瞑想、AI先生、ヨガ探しなどをご案内できます。\n今日は何をしてみたいですか？";

    case "TODAY_YOGA":
      return isLoggedIn
        ? "今日のヨガプログラムをご案内します。\n画面下のメニューを開いて『今日のヨガ』をタップしてください。"
        : "今日のヨガをご案内できます。\n画面下のメニューを開いて『AI先生』をタップして、あなたに合った実践を始めてみませんか？";

    case "BREATHING":
      return "呼吸法のご案内ですね。\nBox Breathing（4秒吸う・4秒止める・4秒吐く・4秒止める）は、落ち着きたい時に手軽にできます。\n画面下のメニューを開いて『AI先生』をタップすると、手順とタイマー付きでご案内できます。";

    case "MEDITATION":
      return "瞑想のご案内ですね。\n1分間のマインドフルネスから始めるのがおすすめです。\n画面下のメニューを開いて『AI先生』をタップすると、手順付きでご案内できます。";

    case "PRACTICE_HISTORY":
      return isLoggedIn
        ? "これまでの実践記録はこちらで確認できます。\n画面下のメニューを開いて『カルテ』をタップしてください。"
        : "実践記録を見るには、LIFFログインが必要です。\n画面下のメニューを開いて『AI先生』をタップしてログインすると、記録が保存されます。";

    case "AI_TEACHER":
      return "AI先生と対話できます。\n画面下のメニューを開いて『AI先生』をタップしてください。";

    case "SEARCH_YOGA":
      return "ヨガスタジオやイベントを探せます。\n画面下のメニューを開いて『ヨガを探す』をタップしてください。";
    ...
    default:
      return isLoggedIn
        ? "ヨガに関するご相談ですね。\n画面下のメニューを開いて『AI先生』をタップすると、詳しくご案内できます。"
        : "ヨガに関するご相談ですね。\n画面下のメニューを開いて『AI先生』をタップすると、あなたに合った実践をご案内できます。";
  }
}
